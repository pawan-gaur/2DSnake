...
public class Gameplay extends JPanel implements KeyListener, ActionListener{
	...
	public void paint(Graphics g){
		...
		for(int collision = 1; collision < lengthofsanke; collision++){
			if(snakexlength[collision] == snakexlength[0] && snakeylength[collision] == snakeylength[0]){
				right = false;
				left = false;
				up = false;
				down = false;
	...
	public void actionPerformed(ActionEvent e) {
		timer.start();
		if(right){
			for(int r = lengthofsanke-1; r >=0; r--){
